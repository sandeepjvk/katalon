...
CustomKeywords.'pages.CheckOut.setSelectItemBarcode'(activeBarcodes,NumberOfBarcodes)

'Set Inactive Item Barcode'
CustomKeywords.'pages.CheckOut.setSelectItemBarcode'(inactiveBarcodes,NumberOfBarcodes)
