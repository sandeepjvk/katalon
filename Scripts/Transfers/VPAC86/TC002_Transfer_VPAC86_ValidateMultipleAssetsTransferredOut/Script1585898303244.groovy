...
CustomKeywords.'pages.CheckOut.setSelectItemBarcode'(activeBarcodes,NumberOfBarcodesToAdd)
...
CustomKeywords.'pages.CheckOut.validateCurrentLocationField'(NumberOfBarcodesToAdd)

'Select Save Button'
CustomKeywords.'pages.CommonActions.clickOnSaveButton'()

'Validation of ID From To Person Barcode'
CustomKeywords.'pages.CheckOut.validationOfIdFromToPersonBarcode'(FromLocation, ToLocation)
